...
public class MainPage extends JFrame implements ActionListener{
	...
	public MainPage(){             //设计界面
        ...
        bc1.setIcon(new ImageIcon("D://iCal图标/计算器.png"));
        ...
        bc2.setIcon(new ImageIcon("D://iCal图标/校园.png"));
        ...
        bc3.setIcon(new ImageIcon("D://iCal图标/挂科.png"));
	...
	public void actionPerformed(ActionEvent e){  //所有按钮的action事件监听器
		...
		if(e.getSource() == bc3){
		    ...
		    window.setTitle("挂科预测");           //挂科预测界面被创建
			window.setFont(font);
			window.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);       //添加关闭按钮
			window.pack();
